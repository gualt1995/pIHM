...
public class CardListAdapter extends RecyclerView.Adapter<CardListAdapter.ViewHolder> {
    ...
    public CardListAdapter(MenuApplication app) {
        this.app = app;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        map.put(1,"Appetizers");
        map.put(2,"Main courses");
        map.put(3,"Sides dishes ");
        map.put(4,"Desserts");
        map.put(5,"Drinks");
        ...
        holder.itemListView.setAdapter(app.getItemListAdapter(position+1));
    }

    // Return the size of your dataset (invoked by the layout manager)
    @Override
    public int getItemCount() {
        return app.getMenuBySize().size();
    }
}
